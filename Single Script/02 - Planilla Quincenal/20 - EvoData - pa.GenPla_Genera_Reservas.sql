...
select @codtrs_isss = trs_codigo from sal.trs_tipos_reserva where trs_abreviatura='PROV_SSPatronal' and trs_codcia=@codcia   
select @codtrs_seg_educativo = trs_codigo from sal.trs_tipos_reserva where trs_abreviatura='PROV_SEPatronal' and trs_codcia=@codcia
select @codtrs_indemnizacion = trs_codigo from sal.trs_tipos_reserva where trs_abreviatura='PROV_INDEM' and trs_codcia=@codcia
select @codtrs_prima_antiguedad = trs_codigo from sal.trs_tipos_reserva where trs_abreviatura='PROV_Prima_Anti' and trs_codcia=@codcia
select @codtrs_vacacion = trs_codigo from sal.trs_tipos_reserva where trs_abreviatura='PROV_VAC' and trs_codcia=@codcia
select @codtrs_xiii_mes = trs_codigo from sal.trs_tipos_reserva where trs_abreviatura='PROV_XIII' and trs_codcia=@codcia
select @codtrs_riesgo_prof = trs_codigo from sal.trs_tipos_reserva where trs_abreviatura='PROV_Riesgo' and trs_codcia=@codcia
