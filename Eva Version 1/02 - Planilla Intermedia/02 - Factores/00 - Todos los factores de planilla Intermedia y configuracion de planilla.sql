...
delete from [sal].[fat_factores_tipo_planilla] where [fat_codtpl] = 4;
delete from [sal].[ftp_formulacion_tipos_planilla] where [ftp_codtpl] = 4;
...
delete from [sal].[fac_factores] where [fac_codigo] = 'D08AF6E4-0DA0-48A5-A46A-7917F2C90C5D';
...
delete from [sal].[fac_factores] where [fac_codigo] = '5CBE3135-6C4A-46AC-8927-FCACE58FAD04';
...
delete from [sal].[fac_factores] where [fac_codigo] = '213D36BC-452A-444D-9814-F826136D52B4';
...
delete from [sal].[fac_factores] where [fac_codigo] = '0C62DA23-33DF-457D-A7E2-49C0DE23F86F';
...
delete from [sal].[fac_factores] where [fac_codigo] = '8715BE23-2AD6-41AA-836C-E015C4BF9F71';
...
delete from [sal].[fac_factores] where [fac_codigo] = 'd01c3419-19d4-4852-ae64-ffd7371186cf';
...
insert into [sal].[ftp_formulacion_tipos_planilla] ([ftp_codtpl],[ftp_prefijo],[ftp_table_name],[ftp_codfac_filtro],[ftp_codfcu_loop],[ftp_sp_inicializacion],[ftp_sp_finalizacion],[ftp_sp_autorizacion]) values (4,'aju','pa.aju_ajustes','7217DB5E-140E-436F-BC30-A21EEB5098B8',(select fcu_codigo from (select RowNum = row_number() OVER ( order by fcu_codigo ), fcu_codigo from sal.fcu_formulacion_cursores where fcu_codpai = 'pa' and fcu_proceso = 'Planilla') tcr where tcr.RowNum = 42),'pa.GenPla_Inicializacion','pa.GenPla_Finalizacion','pa.aupla_Autoriza_planilla');

set identity_insert [sal].[fat_factores_tipo_planilla] on;
insert into [sal].[fat_factores_tipo_planilla] ([fat_codigo],[fat_codtpl],[fat_codfac],[fat_precedencia],[fat_codtig],[fat_codtdc],[fat_codtrs],[fat_salva_en_tabla]) values (103,4,'7217DB5E-140E-436F-BC30-A21EEB5098B8',1,NULL,NULL,NULL,1);
set identity_insert [sal].[fat_factores_tipo_planilla] off;


set identity_insert [sal].[fat_factores_tipo_planilla] on;
insert into [sal].[fat_factores_tipo_planilla] ([fat_codigo],[fat_codtpl],[fat_codfac],[fat_precedencia],[fat_codtig],[fat_codtdc],[fat_codtrs],[fat_salva_en_tabla]) values (104,4,'D08AF6E4-0DA0-48A5-A46A-7917F2C90C5D',10,NULL,3,NULL,1);
set identity_insert [sal].[fat_factores_tipo_planilla] off;


set identity_insert [sal].[fat_factores_tipo_planilla] on;
insert into [sal].[fat_factores_tipo_planilla] ([fat_codigo],[fat_codtpl],[fat_codfac],[fat_precedencia],[fat_codtig],[fat_codtdc],[fat_codtrs],[fat_salva_en_tabla]) values (105,4,'5CBE3135-6C4A-46AC-8927-FCACE58FAD04',12,NULL,4,NULL,1);
set identity_insert [sal].[fat_factores_tipo_planilla] off;


set identity_insert [sal].[fat_factores_tipo_planilla] on;
insert into [sal].[fat_factores_tipo_planilla] ([fat_codigo],[fat_codtpl],[fat_codfac],[fat_precedencia],[fat_codtig],[fat_codtdc],[fat_codtrs],[fat_salva_en_tabla]) values (106,4,'213D36BC-452A-444D-9814-F826136D52B4',13,NULL,NULL,NULL,1);
set identity_insert [sal].[fat_factores_tipo_planilla] off;


set identity_insert [sal].[fat_factores_tipo_planilla] on;
insert into [sal].[fat_factores_tipo_planilla] ([fat_codigo],[fat_codtpl],[fat_codfac],[fat_precedencia],[fat_codtig],[fat_codtdc],[fat_codtrs],[fat_salva_en_tabla]) values (107,4,'74A11C69-2905-4645-9CA6-225EF691E0D3',14,NULL,NULL,NULL,1);
set identity_insert [sal].[fat_factores_tipo_planilla] off;


set identity_insert [sal].[fat_factores_tipo_planilla] on;
insert into [sal].[fat_factores_tipo_planilla] ([fat_codigo],[fat_codtpl],[fat_codfac],[fat_precedencia],[fat_codtig],[fat_codtdc],[fat_codtrs],[fat_salva_en_tabla]) values (108,4,'7D1AF3D1-70A8-4168-8C97-E62AEFBA44B2',2,NULL,NULL,NULL,1);
set identity_insert [sal].[fat_factores_tipo_planilla] off;


set identity_insert [sal].[fat_factores_tipo_planilla] on;
insert into [sal].[fat_factores_tipo_planilla] ([fat_codigo],[fat_codtpl],[fat_codfac],[fat_precedencia],[fat_codtig],[fat_codtdc],[fat_codtrs],[fat_salva_en_tabla]) values (109,4,'1168CFE1-DEB7-4635-AC83-98B929C65E25',5,NULL,NULL,NULL,1);
set identity_insert [sal].[fat_factores_tipo_planilla] off;


set identity_insert [sal].[fat_factores_tipo_planilla] on;
insert into [sal].[fat_factores_tipo_planilla] ([fat_codigo],[fat_codtpl],[fat_codfac],[fat_precedencia],[fat_codtig],[fat_codtdc],[fat_codtrs],[fat_salva_en_tabla]) values (110,4,'52B98440-8B49-4F68-82D8-5A759D306FFD',11,NULL,NULL,NULL,1);
set identity_insert [sal].[fat_factores_tipo_planilla] off;


set identity_insert [sal].[fat_factores_tipo_planilla] on;
insert into [sal].[fat_factores_tipo_planilla] ([fat_codigo],[fat_codtpl],[fat_codfac],[fat_precedencia],[fat_codtig],[fat_codtdc],[fat_codtrs],[fat_salva_en_tabla]) values (111,4,'C2EB06BF-4002-4628-8E86-5B1C88CC0F6D',9,NULL,NULL,NULL,1);
set identity_insert [sal].[fat_factores_tipo_planilla] off;


set identity_insert [sal].[fat_factores_tipo_planilla] on;
insert into [sal].[fat_factores_tipo_planilla] ([fat_codigo],[fat_codtpl],[fat_codfac],[fat_precedencia],[fat_codtig],[fat_codtdc],[fat_codtrs],[fat_salva_en_tabla]) values (112,4,'0C62DA23-33DF-457D-A7E2-49C0DE23F86F',6,NULL,1,4,1);
set identity_insert [sal].[fat_factores_tipo_planilla] off;


set identity_insert [sal].[fat_factores_tipo_planilla] on;
insert into [sal].[fat_factores_tipo_planilla] ([fat_codigo],[fat_codtpl],[fat_codfac],[fat_precedencia],[fat_codtig],[fat_codtdc],[fat_codtrs],[fat_salva_en_tabla]) values (113,4,'D0EE2447-A9ED-40B9-AD16-B2FA76F70C5D',7,NULL,NULL,NULL,1);
set identity_insert [sal].[fat_factores_tipo_planilla] off;


set identity_insert [sal].[fat_factores_tipo_planilla] on;
insert into [sal].[fat_factores_tipo_planilla] ([fat_codigo],[fat_codtpl],[fat_codfac],[fat_precedencia],[fat_codtig],[fat_codtdc],[fat_codtrs],[fat_salva_en_tabla]) values (114,4,'8715BE23-2AD6-41AA-836C-E015C4BF9F71',8,NULL,2,5,1);
set identity_insert [sal].[fat_factores_tipo_planilla] off;


set identity_insert [sal].[fat_factores_tipo_planilla] on;
insert into [sal].[fat_factores_tipo_planilla] ([fat_codigo],[fat_codtpl],[fat_codfac],[fat_precedencia],[fat_codtig],[fat_codtdc],[fat_codtrs],[fat_salva_en_tabla]) values (115,4,'B023400F-182F-4905-848E-1529A8266869',3,NULL,NULL,NULL,1);
set identity_insert [sal].[fat_factores_tipo_planilla] off;


set identity_insert [sal].[fat_factores_tipo_planilla] on;
insert into [sal].[fat_factores_tipo_planilla] ([fat_codigo],[fat_codtpl],[fat_codfac],[fat_precedencia],[fat_codtig],[fat_codtdc],[fat_codtrs],[fat_salva_en_tabla]) values (116,4,'d01c3419-19d4-4852-ae64-ffd7371186cf',4,NULL,NULL,NULL,1);
set identity_insert [sal].[fat_factores_tipo_planilla] off;
