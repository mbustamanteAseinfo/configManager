...
if not exists (select 1 from gen.apa_alcances_parametros where apa_codpar = 'PA_TablaRentaMensual' and apa_codpai = 'pa')
begin
...
values (null,null,'PA_TablaRentaMensual','pa',NULL,NULL,NULL,NULL,NULL, NULL, NULL, NULL)
