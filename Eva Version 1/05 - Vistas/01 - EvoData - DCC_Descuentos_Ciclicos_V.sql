...
SELECT dcc_codigo,dcc_codemp,dcc_referencia,dcc_codtcc,dcc_codbca,dcc_fecha,dcc_fecha_inicio_descuento,dcc_codtdc,dcc_monto_indefinido,
dcc_usa_porcentaje,dcc_porcentaje,dcc_codagr,dcc_monto,dcc_numero_cuotas,dcc_codmon,dcc_frecuencia_cuota,dcc_total_cobrado,
dcc_total_no_cobrado,dcc_saldo,dcc_codtpl,dcc_frecuencia_periodo_pla,dcc_mes_no_descuenta,dcc_accion_liquidacion,dcc_observacion,
dcc_activo,dcc_estado, ISNULL(cdc_ultima_cuota,0) dcc_ultima_cuota_pagada, ISNULL(cdc_ultima_cuota,0) + 1 dcc_proxima_cuota,
