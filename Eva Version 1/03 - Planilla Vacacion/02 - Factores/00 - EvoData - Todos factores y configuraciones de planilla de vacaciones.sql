...
delete from [sal].[fat_factores_tipo_planilla] where [fat_codtpl] = 3;
delete from [sal].[ftp_formulacion_tipos_planilla] where [ftp_codtpl] = 3;


/* Script Generado por Evolution - Editor de Formulación de Planillas. 16-01-2017 4:11 PM */

delete from [sal].[fac_factores] where [fac_codigo] = '2546c770-9e24-437a-90dd-236d44a5c706';
...
delete from [sal].[fac_factores] where [fac_codigo] = 'ea4d0a07-d399-45b0-bfb7-f07ef5f8c8be';
...
delete from [sal].[fac_factores] where [fac_codigo] = '6c388dd7-fcea-46cf-904b-a8f7734e44c4';
...
delete from [sal].[fac_factores] where [fac_codigo] = '610ea80b-7768-4853-94ce-31ce32abb8ee';
...
delete from [sal].[fac_factores] where [fac_codigo] = '113a5429-05e5-4492-b046-a8efccf4866b';
...
delete from [sal].[fac_factores] where [fac_codigo] = '9107bb74-d1e7-4dee-b8dd-eb6c5061963f';
...
delete from [sal].[fac_factores] where [fac_codigo] = 'f461c66c-e739-45a6-8da9-8d78294d0301';
...
delete from [sal].[fac_factores] where [fac_codigo] = '5756f168-f8b2-4638-8075-ca7149f5e78c';
...
delete from [sal].[fac_factores] where [fac_codigo] = 'a8748a9f-b066-4224-99c4-5305531e724e';
...
delete from [sal].[fac_factores] where [fac_codigo] = '9351d3c2-6d78-49f1-9c8f-571fbaf75a3c';
...
delete from [sal].[fac_factores] where [fac_codigo] = 'ca0fc64b-7958-4c29-8e66-3b7862059945';
...
insert into [sal].[ftp_formulacion_tipos_planilla] ([ftp_codtpl],[ftp_prefijo],[ftp_table_name],[ftp_codfac_filtro],[ftp_codfcu_loop],[ftp_sp_inicializacion],[ftp_sp_finalizacion],[ftp_sp_autorizacion]) values (3,'vac','pa.vac_vacacion','2546c770-9e24-437a-90dd-236d44a5c706',(select fcu_codigo from (select RowNum = row_number() OVER ( order by fcu_codigo ), fcu_codigo from sal.fcu_formulacion_cursores where fcu_codpai = 'pa' and fcu_proceso = 'Planilla') tcr where tcr.RowNum = 35),'pa.GenPla_Inicializacion_vac','pa.GenPla_Finalizacion','pa.aupla_autoriza_planilla_vac');

set identity_insert [sal].[fat_factores_tipo_planilla] on;
insert into [sal].[fat_factores_tipo_planilla] ([fat_codigo],[fat_codtpl],[fat_codfac],[fat_precedencia],[fat_codtig],[fat_codtdc],[fat_codtrs],[fat_salva_en_tabla]) values (64,3,'2546c770-9e24-437a-90dd-236d44a5c706',1,NULL,NULL,NULL,0);
set identity_insert [sal].[fat_factores_tipo_planilla] off;


set identity_insert [sal].[fat_factores_tipo_planilla] on;
insert into [sal].[fat_factores_tipo_planilla] ([fat_codigo],[fat_codtpl],[fat_codfac],[fat_precedencia],[fat_codtig],[fat_codtdc],[fat_codtrs],[fat_salva_en_tabla]) values (65,3,'ea4d0a07-d399-45b0-bfb7-f07ef5f8c8be',2,NULL,NULL,NULL,1);
set identity_insert [sal].[fat_factores_tipo_planilla] off;


set identity_insert [sal].[fat_factores_tipo_planilla] on;
insert into [sal].[fat_factores_tipo_planilla] ([fat_codigo],[fat_codtpl],[fat_codfac],[fat_precedencia],[fat_codtig],[fat_codtdc],[fat_codtrs],[fat_salva_en_tabla]) values (66,3,'6c388dd7-fcea-46cf-904b-a8f7734e44c4',3,NULL,NULL,NULL,1);
set identity_insert [sal].[fat_factores_tipo_planilla] off;


set identity_insert [sal].[fat_factores_tipo_planilla] on;
insert into [sal].[fat_factores_tipo_planilla] ([fat_codigo],[fat_codtpl],[fat_codfac],[fat_precedencia],[fat_codtig],[fat_codtdc],[fat_codtrs],[fat_salva_en_tabla]) values (67,3,'610ea80b-7768-4853-94ce-31ce32abb8ee',4,NULL,NULL,NULL,1);
set identity_insert [sal].[fat_factores_tipo_planilla] off;


set identity_insert [sal].[fat_factores_tipo_planilla] on;
insert into [sal].[fat_factores_tipo_planilla] ([fat_codigo],[fat_codtpl],[fat_codfac],[fat_precedencia],[fat_codtig],[fat_codtdc],[fat_codtrs],[fat_salva_en_tabla]) values (68,3,'8ccb605d-b740-45b3-8b0b-eb669004b406',5,5,NULL,NULL,1);
set identity_insert [sal].[fat_factores_tipo_planilla] off;


set identity_insert [sal].[fat_factores_tipo_planilla] on;
insert into [sal].[fat_factores_tipo_planilla] ([fat_codigo],[fat_codtpl],[fat_codfac],[fat_precedencia],[fat_codtig],[fat_codtdc],[fat_codtrs],[fat_salva_en_tabla]) values (69,3,'979e2f29-5185-4ce8-af52-f90ae5a5bbaa',6,6,NULL,NULL,1);
set identity_insert [sal].[fat_factores_tipo_planilla] off;


set identity_insert [sal].[fat_factores_tipo_planilla] on;
insert into [sal].[fat_factores_tipo_planilla] ([fat_codigo],[fat_codtpl],[fat_codfac],[fat_precedencia],[fat_codtig],[fat_codtdc],[fat_codtrs],[fat_salva_en_tabla]) values (75,3,'113a5429-05e5-4492-b046-a8efccf4866b',7,NULL,NULL,NULL,1);
set identity_insert [sal].[fat_factores_tipo_planilla] off;


set identity_insert [sal].[fat_factores_tipo_planilla] on;
insert into [sal].[fat_factores_tipo_planilla] ([fat_codigo],[fat_codtpl],[fat_codfac],[fat_precedencia],[fat_codtig],[fat_codtdc],[fat_codtrs],[fat_salva_en_tabla]) values (79,3,'ee0880a3-a8f6-4709-a3ab-4976e54ecbaf',8,NULL,NULL,NULL,1);
set identity_insert [sal].[fat_factores_tipo_planilla] off;


set identity_insert [sal].[fat_factores_tipo_planilla] on;
insert into [sal].[fat_factores_tipo_planilla] ([fat_codigo],[fat_codtpl],[fat_codfac],[fat_precedencia],[fat_codtig],[fat_codtdc],[fat_codtrs],[fat_salva_en_tabla]) values (82,3,'9107bb74-d1e7-4dee-b8dd-eb6c5061963f',9,NULL,NULL,NULL,1);
set identity_insert [sal].[fat_factores_tipo_planilla] off;


set identity_insert [sal].[fat_factores_tipo_planilla] on;
insert into [sal].[fat_factores_tipo_planilla] ([fat_codigo],[fat_codtpl],[fat_codfac],[fat_precedencia],[fat_codtig],[fat_codtdc],[fat_codtrs],[fat_salva_en_tabla]) values (83,3,'bd1aad4d-73f9-4a2d-87af-4f785ce10312',10,NULL,NULL,NULL,1);
set identity_insert [sal].[fat_factores_tipo_planilla] off;


set identity_insert [sal].[fat_factores_tipo_planilla] on;
insert into [sal].[fat_factores_tipo_planilla] ([fat_codigo],[fat_codtpl],[fat_codfac],[fat_precedencia],[fat_codtig],[fat_codtdc],[fat_codtrs],[fat_salva_en_tabla]) values (85,3,'4e81387b-73f1-455e-8577-0ad288ea090d',11,NULL,1,NULL,1);
set identity_insert [sal].[fat_factores_tipo_planilla] off;


set identity_insert [sal].[fat_factores_tipo_planilla] on;
insert into [sal].[fat_factores_tipo_planilla] ([fat_codigo],[fat_codtpl],[fat_codfac],[fat_precedencia],[fat_codtig],[fat_codtdc],[fat_codtrs],[fat_salva_en_tabla]) values (88,3,'1be95969-50e8-4dab-8d45-b1056eede314',12,NULL,NULL,NULL,1);
set identity_insert [sal].[fat_factores_tipo_planilla] off;


set identity_insert [sal].[fat_factores_tipo_planilla] on;
insert into [sal].[fat_factores_tipo_planilla] ([fat_codigo],[fat_codtpl],[fat_codfac],[fat_precedencia],[fat_codtig],[fat_codtdc],[fat_codtrs],[fat_salva_en_tabla]) values (89,3,'8b29cd99-cc00-4177-8cde-694527f86554',13,NULL,NULL,NULL,1);
set identity_insert [sal].[fat_factores_tipo_planilla] off;


set identity_insert [sal].[fat_factores_tipo_planilla] on;
insert into [sal].[fat_factores_tipo_planilla] ([fat_codigo],[fat_codtpl],[fat_codfac],[fat_precedencia],[fat_codtig],[fat_codtdc],[fat_codtrs],[fat_salva_en_tabla]) values (90,3,'ff82a755-fc64-421c-a8e0-8a3d722861d4',14,NULL,2,NULL,1);
set identity_insert [sal].[fat_factores_tipo_planilla] off;


set identity_insert [sal].[fat_factores_tipo_planilla] on;
insert into [sal].[fat_factores_tipo_planilla] ([fat_codigo],[fat_codtpl],[fat_codfac],[fat_precedencia],[fat_codtig],[fat_codtdc],[fat_codtrs],[fat_salva_en_tabla]) values (92,3,'48c4597a-bc15-414d-b312-80ede54a79e9',15,NULL,NULL,NULL,1);
set identity_insert [sal].[fat_factores_tipo_planilla] off;


set identity_insert [sal].[fat_factores_tipo_planilla] on;
insert into [sal].[fat_factores_tipo_planilla] ([fat_codigo],[fat_codtpl],[fat_codfac],[fat_precedencia],[fat_codtig],[fat_codtdc],[fat_codtrs],[fat_salva_en_tabla]) values (93,3,'6a5ea415-9181-47a9-969c-12a5cf9169a4',16,NULL,NULL,NULL,1);
set identity_insert [sal].[fat_factores_tipo_planilla] off;


set identity_insert [sal].[fat_factores_tipo_planilla] on;
insert into [sal].[fat_factores_tipo_planilla] ([fat_codigo],[fat_codtpl],[fat_codfac],[fat_precedencia],[fat_codtig],[fat_codtdc],[fat_codtrs],[fat_salva_en_tabla]) values (94,3,'f461c66c-e739-45a6-8da9-8d78294d0301',17,NULL,NULL,NULL,1);
set identity_insert [sal].[fat_factores_tipo_planilla] off;


set identity_insert [sal].[fat_factores_tipo_planilla] on;
insert into [sal].[fat_factores_tipo_planilla] ([fat_codigo],[fat_codtpl],[fat_codfac],[fat_precedencia],[fat_codtig],[fat_codtdc],[fat_codtrs],[fat_salva_en_tabla]) values (95,3,'5756f168-f8b2-4638-8075-ca7149f5e78c',18,NULL,NULL,NULL,1);
set identity_insert [sal].[fat_factores_tipo_planilla] off;


set identity_insert [sal].[fat_factores_tipo_planilla] on;
insert into [sal].[fat_factores_tipo_planilla] ([fat_codigo],[fat_codtpl],[fat_codfac],[fat_precedencia],[fat_codtig],[fat_codtdc],[fat_codtrs],[fat_salva_en_tabla]) values (96,3,'a8748a9f-b066-4224-99c4-5305531e724e',19,NULL,3,NULL,1);
set identity_insert [sal].[fat_factores_tipo_planilla] off;


set identity_insert [sal].[fat_factores_tipo_planilla] on;
insert into [sal].[fat_factores_tipo_planilla] ([fat_codigo],[fat_codtpl],[fat_codfac],[fat_precedencia],[fat_codtig],[fat_codtdc],[fat_codtrs],[fat_salva_en_tabla]) values (97,3,'9351d3c2-6d78-49f1-9c8f-571fbaf75a3c',20,NULL,4,NULL,1);
set identity_insert [sal].[fat_factores_tipo_planilla] off;


set identity_insert [sal].[fat_factores_tipo_planilla] on;
insert into [sal].[fat_factores_tipo_planilla] ([fat_codigo],[fat_codtpl],[fat_codfac],[fat_precedencia],[fat_codtig],[fat_codtdc],[fat_codtrs],[fat_salva_en_tabla]) values (100,3,'e0dc35bb-f005-454d-826b-33048b6ddb2f',21,NULL,NULL,NULL,1);
set identity_insert [sal].[fat_factores_tipo_planilla] off;


set identity_insert [sal].[fat_factores_tipo_planilla] on;
insert into [sal].[fat_factores_tipo_planilla] ([fat_codigo],[fat_codtpl],[fat_codfac],[fat_precedencia],[fat_codtig],[fat_codtdc],[fat_codtrs],[fat_salva_en_tabla]) values (101,3,'ca0fc64b-7958-4c29-8e66-3b7862059945',22,NULL,NULL,NULL,1);
set identity_insert [sal].[fat_factores_tipo_planilla] off;


set identity_insert [sal].[fat_factores_tipo_planilla] on;
insert into [sal].[fat_factores_tipo_planilla] ([fat_codigo],[fat_codtpl],[fat_codfac],[fat_precedencia],[fat_codtig],[fat_codtdc],[fat_codtrs],[fat_salva_en_tabla]) values (102,3,'9b5cea25-b38d-4e75-9af0-a5a4c0499a50',23,NULL,NULL,NULL,1);
set identity_insert [sal].[fat_factores_tipo_planilla] off;
