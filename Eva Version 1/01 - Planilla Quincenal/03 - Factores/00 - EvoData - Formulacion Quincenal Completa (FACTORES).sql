...
delete from [sal].[fac_factores] where [fac_codigo] = '5170a1c5-de74-4d09-b6dd-e324c59613ac';
...
delete from [sal].[fac_factores] where [fac_codigo] = '414ac74e-04fb-4441-b8ca-f50162b95dbb';
...
delete from [sal].[fac_factores] where [fac_codigo] = '77ebc94e-3505-46e0-9f32-b6c4475d1e6b';
...
delete from [sal].[fac_factores] where [fac_codigo] = '8e473186-3b82-4b7f-9f25-b5ee874e5124';
...
delete from [sal].[fac_factores] where [fac_codigo] = '0d214ad6-e1ef-4500-aa69-51fbe539c264';
...
delete from [sal].[fac_factores] where [fac_codigo] = 'f0017293-0f88-4516-b35c-4964d32e292b';
...
delete from [sal].[fac_factores] where [fac_codigo] = '85ae6a9f-ceff-45dd-9cff-af297e52b69f';
...
delete from [sal].[fac_factores] where [fac_codigo] = 'f9dc52a5-30ea-4957-9f17-54954d0a4a7e';
...
delete from [sal].[fac_factores] where [fac_codigo] = '9c60e57a-b6c2-43cf-89b6-61cb8b122bf9';
...
delete from [sal].[fac_factores] where [fac_codigo] = '59c6d4c3-e1d5-46d0-9641-ea7994f7e124';
...
delete from [sal].[fac_factores] where [fac_codigo] = '0b6f201f-7443-4aa8-a466-e670027ad6b4';
...
delete from [sal].[fac_factores] where [fac_codigo] = 'fd68b0c7-2e7c-4ad5-89e4-fab4f61c8f0b';
...
delete from [sal].[fac_factores] where [fac_codigo] = 'c5dc36f7-0685-4a27-a9a5-824f8aeaa292';
...
delete from [sal].[fac_factores] where [fac_codigo] = 'a22c44d2-0eba-4a41-9784-90484819f221';
...
delete from [sal].[fac_factores] where [fac_codigo] = '82e83429-b3d4-4dd6-ac0c-c0749d423e48';
...
delete from [sal].[fac_factores] where [fac_codigo] = '9559bb84-5dfe-4a9d-aad8-f581d8cbe0f4';
...
(1,'qui','pa.qui_quincenal','1c322de6-4789-4232-bc28-a148e5e45a8e',(select fcu_codigo from (select RowNum = row_number() OVER ( order by fcu_codigo ), fcu_codigo from sal.fcu_formulacion_cursores where fcu_codpai = 'pa' and fcu_proceso = 'Planilla') tcr where tcr.RowNum = 12),'pa.GenPla_Inicializacion','pa.GenPla_Finalizacion','pa.aupla_autoriza_planilla');

set identity_insert [sal].[fat_factores_tipo_planilla] on;
insert into [sal].[fat_factores_tipo_planilla] ([fat_codigo],[fat_codtpl],[fat_codfac],[fat_precedencia],[fat_codtig],[fat_codtdc],[fat_codtrs],[fat_salva_en_tabla]) values (1,1,'1c322de6-4789-4232-bc28-a148e5e45a8e',1,NULL,NULL,NULL,0);
set identity_insert [sal].[fat_factores_tipo_planilla] off;


set identity_insert [sal].[fat_factores_tipo_planilla] on;
insert into [sal].[fat_factores_tipo_planilla] ([fat_codigo],[fat_codtpl],[fat_codfac],[fat_precedencia],[fat_codtig],[fat_codtdc],[fat_codtrs],[fat_salva_en_tabla]) values (4,1,'dd8c90cd-3e65-431a-b301-65b19c4c1f35',2,NULL,NULL,NULL,1);
set identity_insert [sal].[fat_factores_tipo_planilla] off;


set identity_insert [sal].[fat_factores_tipo_planilla] on;
insert into [sal].[fat_factores_tipo_planilla] ([fat_codigo],[fat_codtpl],[fat_codfac],[fat_precedencia],[fat_codtig],[fat_codtdc],[fat_codtrs],[fat_salva_en_tabla]) values (5,1,'86d5188e-2120-49b9-8b98-a57a2d7772bd',4,NULL,NULL,NULL,1);
set identity_insert [sal].[fat_factores_tipo_planilla] off;


set identity_insert [sal].[fat_factores_tipo_planilla] on;
insert into [sal].[fat_factores_tipo_planilla] ([fat_codigo],[fat_codtpl],[fat_codfac],[fat_precedencia],[fat_codtig],[fat_codtdc],[fat_codtrs],[fat_salva_en_tabla]) values (6,1,'c1e6999c-9b4d-4a8d-825b-ef938d1891d1',5,NULL,NULL,NULL,1);
set identity_insert [sal].[fat_factores_tipo_planilla] off;


set identity_insert [sal].[fat_factores_tipo_planilla] on;
insert into [sal].[fat_factores_tipo_planilla] ([fat_codigo],[fat_codtpl],[fat_codfac],[fat_precedencia],[fat_codtig],[fat_codtdc],[fat_codtrs],[fat_salva_en_tabla]) values (7,1,'6bbc67e0-c6cd-490c-9257-2d496a48735d',6,1,NULL,NULL,1);
set identity_insert [sal].[fat_factores_tipo_planilla] off;


set identity_insert [sal].[fat_factores_tipo_planilla] on;
insert into [sal].[fat_factores_tipo_planilla] ([fat_codigo],[fat_codtpl],[fat_codfac],[fat_precedencia],[fat_codtig],[fat_codtdc],[fat_codtrs],[fat_salva_en_tabla]) values (8,1,'5170a1c5-de74-4d09-b6dd-e324c59613ac',7,2,NULL,NULL,1);
set identity_insert [sal].[fat_factores_tipo_planilla] off;


set identity_insert [sal].[fat_factores_tipo_planilla] on;
insert into [sal].[fat_factores_tipo_planilla] ([fat_codigo],[fat_codtpl],[fat_codfac],[fat_precedencia],[fat_codtig],[fat_codtdc],[fat_codtrs],[fat_salva_en_tabla]) values (9,1,'fe0ffacf-fa45-4ecc-8748-5e70b6b21467',8,33,NULL,NULL,1);
set identity_insert [sal].[fat_factores_tipo_planilla] off;


set identity_insert [sal].[fat_factores_tipo_planilla] on;
insert into [sal].[fat_factores_tipo_planilla] ([fat_codigo],[fat_codtpl],[fat_codfac],[fat_precedencia],[fat_codtig],[fat_codtdc],[fat_codtrs],[fat_salva_en_tabla]) values