...
BEGIN
	...
	BEGIN
		...
		JOIN (
			...
			AND res_codtrs IN ((select trs_codigo from sal.trs_tipos_reserva where trs_abreviatura = 'PROV_SEPatronal_PA' or trs_abreviatura = 'PROV_SSPatronal_PA'))
			...
			ON trs_codigo = res_codtrs
			WHERE res_codppl = @codppl_proceso
			AND res_codtrs IN ((select trs_codigo from sal.trs_tipos_reserva where trs_abreviatura = 'PROV_VAC_PA' or trs_abreviatura = 'PROV_XIII_PA' or trs_abreviatura = 'PROV_INDEM_PA' or trs_abreviatura = 'PROV_Prima_Anti_PA'))
			GROUP BY res_codppl, res_codemp, trs_descripcion, trs_cuenta
			UNION
