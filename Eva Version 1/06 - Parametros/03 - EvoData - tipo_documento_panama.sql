...
GO
insert into tbl_temp_documentos_pan(tdo_codpai, tdo_descripcion, tdo_abreviatura, tdo_nombre_por_segmento, tdo_fmt_nombre_completo) values ('pa','Cédula','CIP',0, '{0} {1} {2} {3} {4} {5}'),
...
('pa','Carnet de Migración','CMI',0,'{0} {1} {2} {3} {4} {5}'),
('pa','Crisol de Razas','--CRR',0,'{0} {1} {2} {3} {4} {5}'),
('pa','Fondo de Cesantías','FCES',0,'{0} {1} {2} {3} {4} {5}'),
