...
delete from [sal].[fat_factores_tipo_planilla] where [fat_codtpl] = 2;
delete from [sal].[ftp_formulacion_tipos_planilla] where [ftp_codtpl] = 2;
...
delete from [sal].[fac_factores] where [fac_codigo] = '3d8f0d05-5f7c-4783-8f26-e8516fcf7202';
...
delete from [sal].[fac_factores] where [fac_codigo] = 'f44f064e-c4e1-48b0-bd59-2da1848a6d30';
...
delete from [sal].[fac_factores] where [fac_codigo] = 'b7ecbdb0-a784-44fc-b2df-d78a39ac538a';
...
delete from [sal].[fac_factores] where [fac_codigo] = 'a2274c4d-3258-439a-b961-048614b51277';
...
delete from [sal].[fac_factores] where [fac_codigo] = '39db6b8c-ff50-46d2-92c3-2ae5423f5bca';
...
delete from [sal].[fac_factores] where [fac_codigo] = '597292e5-30a0-4669-bacc-a15bf419e6f8';
...
delete from [sal].[fac_factores] where [fac_codigo] = 'cb666c61-9488-4263-9109-97647d4435d9';
...
delete from [sal].[fac_factores] where [fac_codigo] = '6d957e26-744a-4259-8abf-6f60cd44b15a';
...
delete from [sal].[fac_factores] where [fac_codigo] = '15148a7e-87ac-4ab3-8288-087f367fe82c';
...
delete from [sal].[fac_factores] where [fac_codigo] = '1da69547-e0e1-450f-aea7-901248e76a99';
...
delete from [sal].[fac_factores] where [fac_codigo] = '6f18ba36-afc3-4034-b6eb-6d01eb800380';
...
insert into [sal].[ftp_formulacion_tipos_planilla] ([ftp_codtpl],[ftp_prefijo],[ftp_table_name],[ftp_codfac_filtro],[ftp_codfcu_loop],[ftp_sp_inicializacion],[ftp_sp_finalizacion],[ftp_sp_autorizacion]) values (2,'ter','pa.ter_decimo','1a6f3ab6-13a3-47a4-96d5-16a695850a05',(select fcu_codigo from (select RowNum = row_number() OVER ( order by fcu_codigo ), fcu_codigo from sal.fcu_formulacion_cursores where fcu_codpai = 'pa' and fcu_proceso = 'Planilla') tcr where tcr.RowNum = 12),'pa.GenPla_Inicializacion_XIII','pa.GenPla_Finalizacion_XIII','pa.aupla_autoriza_planilla');

set identity_insert [sal].[fat_factores_tipo_planilla] on;
insert into [sal].[fat_factores_tipo_planilla] ([fat_codigo],[fat_codtpl],[fat_codfac],[fat_precedencia],[fat_codtig],[fat_codtdc],[fat_codtrs],[fat_salva_en_tabla]) values (42,2,'1a6f3ab6-13a3-47a4-96d5-16a695850a05',1,NULL,NULL,NULL,1);
set identity_insert [sal].[fat_factores_tipo_planilla] off;


set identity_insert [sal].[fat_factores_tipo_planilla] on;
insert into [sal].[fat_factores_tipo_planilla] ([fat_codigo],[fat_codtpl],[fat_codfac],[fat_precedencia],[fat_codtig],[fat_codtdc],[fat_codtrs],[fat_salva_en_tabla]) values (43,2,'c2da53a4-827e-4fbf-bb42-6c075bd9e2bc',2,NULL,NULL,NULL,1);
set identity_insert [sal].[fat_factores_tipo_planilla] off;


set identity_insert [sal].[fat_factores_tipo_planilla] on;
insert into [sal].[fat_factores_tipo_planilla] ([fat_codigo],[fat_codtpl],[fat_codfac],[fat_precedencia],[fat_codtig],[fat_codtdc],[fat_codtrs],[fat_salva_en_tabla]) values (44,2,'3d8f0d05-5f7c-4783-8f26-e8516fcf7202',3,NULL,NULL,NULL,1);
set identity_insert [sal].[fat_factores_tipo_planilla] off;


set identity_insert [sal].[fat_factores_tipo_planilla] on;
insert into [sal].[fat_factores_tipo_planilla] ([fat_codigo],[fat_codtpl],[fat_codfac],[fat_precedencia],[fat_codtig],[fat_codtdc],[fat_codtrs],[fat_salva_en_tabla]) values (45,2,'f44f064e-c4e1-48b0-bd59-2da1848a6d30',4,NULL,NULL,NULL,1);
set identity_insert [sal].[fat_factores_tipo_planilla] off;


set identity_insert [sal].[fat_factores_tipo_planilla] on;
insert into [sal].[fat_factores_tipo_planilla] ([fat_codigo],[fat_codtpl],[fat_codfac],[fat_precedencia],[fat_codtig],[fat_codtdc],[fat_codtrs],[fat_salva_en_tabla]) values (46,2,'005636ba-b9c4-4f2a-b41b-bca88c984435',5,NULL,NULL,NULL,1);
set identity_insert [sal].[fat_factores_tipo_planilla] off;


set identity_insert [sal].[fat_factores_tipo_planilla] on;
insert into [sal].[fat_factores_tipo_planilla] ([fat_codigo],[fat_codtpl],[fat_codfac],[fat_precedencia],[fat_codtig],[fat_codtdc],[fat_codtrs],[fat_salva_en_tabla]) values (47,2,'b7ecbdb0-a784-44fc-b2df-d78a39ac538a',6,4,NULL,NULL,1);
set identity_insert [sal].[fat_factores_tipo_planilla] off;


set identity_insert [sal].[fat_factores_tipo_planilla] on;
insert into [sal].[fat_factores_tipo_planilla] ([fat_codigo],[fat_codtpl],[fat_codfac],[fat_precedencia],[fat_codtig],[fat_codtdc],[fat_codtrs],[fat_salva_en_tabla]) values (48,2,'a2274c4d-3258-439a-b961-048614b51277',7,3,NULL,NULL,1);
set identity_insert [sal].[fat_factores_tipo_planilla] off;


set identity_insert [sal].[fat_factores_tipo_planilla] on;
insert into [sal].[fat_factores_tipo_planilla] ([fat_codigo],[fat_codtpl],[fat_codfac],[fat_precedencia],[fat_codtig],[fat_codtdc],[fat_codtrs],[fat_salva_en_tabla]) values (49,2,'39db6b8c-ff50-46d2-92c3-2ae5423f5bca',8,NULL,NULL,NULL,1);
set identity_insert [sal].[fat_factores_tipo_planilla] off;


set identity_insert [sal].[fat_factores_tipo_planilla] on;
insert into [sal].[fat_factores_tipo_planilla] ([fat_codigo],[fat_codtpl],[fat_codfac],[fat_precedencia],[fat_codtig],[fat_codtdc],[fat_codtrs],[fat_salva_en_tabla]) values (50,2,'b9bd0f33-6d74-438e-a000-b3c615c1ef90',10,NULL,NULL,NULL,1);
set identity_insert [sal].[fat_factores_tipo_planilla] off;


set identity_insert [sal].[fat_factores_tipo_planilla] on;
insert into [sal].[fat_factores_tipo_planilla] ([fat_codigo],[fat_codtpl],[fat_codfac],[fat_precedencia],[fat_codtig],[fat_codtdc],[fat_codtrs],[fat_salva_en_tabla]) values (51,2,'f7b1bd19-2697-4d79-a121-d1b43fffe130',11,NULL,NULL,NULL,1);
set identity_insert [sal].[fat_factores_tipo_planilla] off;


set identity_insert [sal].[fat_factores_tipo_planilla] on;
insert into [sal].[fat_factores_tipo_planilla] ([fat_codigo],[fat_codtpl],[fat_codfac],[fat_precedencia],[fat_codtig],[fat_codtdc],[fat_codtrs],[fat_salva_en_tabla]) values (52,2,'6dc55c1a-e329-4401-b168-4f9bd221584a',12,NULL,NULL,NULL,1);
set identity_insert [sal].[fat_factores_tipo_planilla] off;


set identity_insert [sal].[fat_factores_tipo_planilla] on;
insert into [sal].[fat_factores_tipo_planilla] ([fat_codigo],[fat_codtpl],[fat_codfac],[fat_precedencia],[fat_codtig],[fat_codtdc],[fat_codtrs],[fat_salva_en_tabla]) values (53,2,'597292e5-30a0-4669-bacc-a15bf419e6f8',13,NULL,NULL,NULL,1);
set identity_insert [sal].[fat_factores_tipo_planilla] off;


set identity_insert [sal].[fat_factores_tipo_planilla] on;
insert into [sal].[fat_factores_tipo_planilla] ([fat_codigo],[fat_codtpl],[fat_codfac],[fat_precedencia],[fat_codtig],[fat_codtdc],[fat_codtrs],[fat_salva_en_tabla]) values (54,2,'cb666c61-9488-4263-9109-97647d4435d9',14,NULL,NULL,NULL,1);
set identity_insert [sal].[fat_factores_tipo_planilla] off;


set identity_insert [sal].[fat_factores_tipo_planilla] on;
insert into [sal].[fat_factores_tipo_planilla] ([fat_codigo],[fat_codtpl],[fat_codfac],[fat_precedencia],[fat_codtig],[fat_codtdc],[fat_codtrs],[fat_salva_en_tabla]) values (55,2,'9db7d3f0-52a2-447e-b64d-f4d4fd2c3c13',15,NULL,NULL,NULL,1);
set identity_insert [sal].[fat_factores_tipo_planilla] off;


set identity_insert [sal].[fat_factores_tipo_planilla] on;
insert into [sal].[fat_factores_tipo_planilla] ([fat_codigo],[fat_codtpl],[fat_codfac],[fat_precedencia],[fat_codtig],[fat_codtdc],[fat_codtrs],[fat_salva_en_tabla]) values (56,2,'6d957e26-744a-4259-8abf-6f60cd44b15a',16,NULL,3,NULL,1);
set identity_insert [sal].[fat_factores_tipo_planilla] off;


set identity_insert [sal].[fat_factores_tipo_planilla] on;
insert into [sal].[fat_factores_tipo_planilla] ([fat_codigo],[fat_codtpl],[fat_codfac],[fat_precedencia],[fat_codtig],[fat_codtdc],[fat_codtrs],[fat_salva_en_tabla]) values (57,2,'15148a7e-87ac-4ab3-8288-087f367fe82c',17,NULL,4,NULL,1);
set identity_insert [sal].[fat_factores_tipo_planilla] off;


set identity_insert [sal].[fat_factores_tipo_planilla] on;
insert into [sal].[fat_factores_tipo_planilla] ([fat_codigo],[fat_codtpl],[fat_codfac],[fat_precedencia],[fat_codtig],[fat_codtdc],[fat_codtrs],[fat_salva_en_tabla]) values (58,2,'3e4ea582-1b4b-4baa-83a4-d7949d452642',18,NULL,NULL,NULL,1);
set identity_insert [sal].[fat_factores_tipo_planilla] off;


set identity_insert [sal].[fat_factores_tipo_planilla] on;
insert into [sal].[fat_factores_tipo_planilla] ([fat_codigo],[fat_codtpl],[fat_codfac],[fat_precedencia],[fat_codtig],[fat_codtdc],[fat_codtrs],[fat_salva_en_tabla]) values (59,2,'da82728a-120a-499b-9398-81d7ea990811',19,NULL,NULL,NULL,1);
set identity_insert [sal].[fat_factores_tipo_planilla] off;


set identity_insert [sal].[fat_factores_tipo_planilla] on;
insert into [sal].[fat_factores_tipo_planilla] ([fat_codigo],[fat_codtpl],[fat_codfac],[fat_precedencia],[fat_codtig],[fat_codtdc],[fat_codtrs],[fat_salva_en_tabla]) values (60,2,'f5949487-5943-449b-ac95-907bca42829e',20,NULL,1,NULL,1);
set identity_insert [sal].[fat_factores_tipo_planilla] off;


set identity_insert [sal].[fat_factores_tipo_planilla] on;
insert into [sal].[fat_factores_tipo_planilla] ([fat_codigo],[fat_codtpl],[fat_codfac],[fat_precedencia],[fat_codtig],[fat_codtdc],[fat_codtrs],[fat_salva_en_tabla]) values (61,2,'f3da6f34-74ef-4311-9002-002ab7099e02',21,NULL,1,NULL,1);
set identity_insert [sal].[fat_factores_tipo_planilla] off;


set identity_insert [sal].[fat_factores_tipo_planilla] on;
insert into [sal].[fat_factores_tipo_planilla] ([fat_codigo],[fat_codtpl],[fat_codfac],[fat_precedencia],[fat_codtig],[fat_codtdc],[fat_codtrs],[fat_salva_en_tabla]) values (62,2,'1da69547-e0e1-450f-aea7-901248e76a99',22,NULL,NULL,NULL,1);
set identity_insert [sal].[fat_factores_tipo_planilla] off;


set identity_insert [sal].[fat_factores_tipo_planilla] on;
insert into [sal].[fat_factores_tipo_planilla] ([fat_codigo],[fat_codtpl],[fat_codfac],[fat_precedencia],[fat_codtig],[fat_codtdc],[fat_codtrs],[fat_salva_en_tabla]) values (63,2,'6f18ba36-afc3-4034-b6eb-6d01eb800380',23,NULL,NULL,NULL,1);
set identity_insert [sal].[fat_factores_tipo_planilla] off;


set identity_insert [sal].[fat_factores_tipo_planilla] on;
insert into [sal].[fat_factores_tipo_planilla] ([fat_codigo],[fat_codtpl],[fat_codfac],[fat_precedencia],[fat_codtig],[fat_codtdc],[fat_codtrs],[fat_salva_en_tabla]) values (117,2,'d9bab822-bee7-4029-98c7-eb2b96516c83',9,NULL,NULL,NULL,1);
set identity_insert [sal].[fat_factores_tipo_planilla] off;
